namespace ResxFormatterTests
{
    ...
    public class FormattingTests
    {
        ...
        {
            // Arrange
            var tempFileName = $"_files\\{Path.GetFileNameWithoutExtension(fileName)}-{Guid.NewGuid()}.resx";
        ...
        internal class ResxTestData : TheoryDataBase<ISettings, string, string, string, string>
        {
            public override IEnumerable<(ISettings, string, string, string, string)> Create()
            {
                ...
                yield return (@default, "Entries are sorted alphabetically.", "Resource1.resx", null, "6F32E0754A956B70FB7C09E29C47CAA38039A365FBE498A68DA73E698DA5D5DF");
                ...
                yield return (noSort, "Entries are only sorted if 'sort' setting is active.", "Resource1.resx", null, "2C4EFA8D11C3B6AE7308FFB182B1794E6D61106B5771B120B06C559C0D1E52DC");
                ...
                yield return (keepComment, "Documentation is only removed if 'doc' setting is active.", "Resource1.resx", null, "E47BF6D02610D33256E4A0E913669CF4A29BB9ED0FEB8DC43628277E960092B8");
                ...
                yield return (doNothing, "Documentation is only removed if 'doc' setting is active.", "Resource1.resx", null, "D9643216D1B2B631BF12C0A3742C570AD460DB634636FB58FD9B98D8565A61F4");
            }
